...
const Navbar = () => {
  ...
  const NavLink = ({ to, label }) => (
    <Link to={to} className="hover:border px-4 py-2 rounded-lg border-gray-300">
      {label}
    </Link>
  );
  ...
  return (
    <nav className="h-20 flex items-center justify-between bg-gray-100 text-black font-semibold px-6 py-4">
      <Link to="/">
      ...
      <div className="hidden sm:flex items-center space-x-6">
        ...
        <NavLink to="/wishlists" label="Wishlist" />

        <div className="relative">
          <button
            className="flex items-center border border-gray-300 rounded-full px-4 py-2 hover:bg-gray-200"
          ...
          >
            <img
              ...
              alt="Profile"
            />
            <svg className="w-3 fill-gray-400 ml-3" viewBox="0 0 24 24">
          ...
          {isProfileOpen && (
            <ul className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
              <li className="flex items-center px-5 py-2.5 cursor-pointer hover:bg-gray-100">
              ...
              <li className="flex items-center px-5 py-2.5 cursor-pointer hover:bg-gray-100">
                ...
                <Link to="/your-orders" onClick={() => setIsProfileOpen(false)}>
                  Your Orders
                </Link>
              </li>
              <li
      ...
      {ishamburgerOpen && (
        <div className="sm:hidden flex flex-col bg-gray-200 p-4 space-y-4">
          <NavLink to="/" label="Home" />
          <NavLink to="/about" label="About" />
          <NavLink to="/cart" label="Cart" />
          <NavLink to="/wishlists" label="Wishlist" />
          <NavLink to="/your-orders" label="orders" />
